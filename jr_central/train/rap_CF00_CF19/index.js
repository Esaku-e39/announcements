$(() => {
    ...
    $(".play").click(function () {
        ...
        if (door == "left") {
            playList.push("door_left_jpn");
            playList.push(selected+"-2");
            playList.push("door_left_eng");
        } else if (door == "both") {
            playList.push("door_both_jpn");
            playList.push(selected+"-2");
            playList.push("door_both_eng");
        } else if (door == "right") {
            playList.push("door_right_jpn");
            playList.push(selected+"-2");
            playList.push("door_right_eng");
        }
