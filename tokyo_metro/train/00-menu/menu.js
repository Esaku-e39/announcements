$(function () {
    ...
    $(".menu").html(
        ...
        '<audio src="../00-menu/sound/train_will_bive.mp3" id="train_will_bive" preload="none"></audio>' +
        '「この先揺れます」[日] <button class="play" value="train_will_bive">a</button><br>' +


        '<h3>マナー啓発</h3>'+ ///////////////////////////////////////////////////////////////////////////////

        '<audio src="../00-menu/sound/depart_sign.mp3" id="depart_sign" preload="none"></audio>' +
